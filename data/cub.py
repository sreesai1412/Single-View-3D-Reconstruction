...
elif osp.exists('/home/vikrant/CMR_expts/CMR_bkup/data'):
    kData = '/home/vikrant/CMR_expts/CMR_bkup/data/CUB_200_2011'
elif osp.exists('/home/tejan/data'): # on 133
    kData = '/home/tejan/data/CUB_200_2011'
else:  # Savio
...
class CubTestDataset(Dataset):
    ...
    def __init__(self, opts, filter_key):
        ...
        pairs = list(zip(rng.choice(all_indices, count), rng.choice(all_indices, count)))
        self.sdset = sdset
        self.tuples = pairs
